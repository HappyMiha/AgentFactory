...
| AF-044 | Not started | AF-005 explicitly limits itself to `health/execute` | No lifecycle-aware `start/resume/heartbeat/cancel/collect_events/finalize` runtime contract |
