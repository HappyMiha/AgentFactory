...
[English portfolio](README.en.md) · Українська

Мова документації: [погоджений двомовний підхід](language-policy.md) · [English language policy](language-policy.en.md). Українські оригінали збережено; повний англомовний портфель доступний паралельно.
